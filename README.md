...
reportlab==3.6.8
cryptography==3.4.7
python-dotenv  # для работы с переменными окружения, если вы используете .env файл
pytest  # для тестирования
pytest-cov  # для покрытия тестами (опционально)
coverage  # для анализа покрытия тестами (опционально)
